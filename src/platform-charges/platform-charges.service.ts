    ...
    async AddPlatformCharge(
        ...
        try {
            ...
            trusteeSchool.platform_charges.forEach((platformCharge) => {
                if (
                    platformCharge.platform_type.toLowerCase() === platform_type.toLowerCase() &&
            ...
            OthersFields.forEach((OthersField) => {
                ...
                res.platform_charges.forEach((PlatformCharge) => {
                    if (
                        PlatformCharge.platform_type.toLowerCase() === OthersField.platform_type.toLowerCase() &&
                        PlatformCharge.payment_mode.toLowerCase() === OthersField.payment_mode.toLowerCase()
                    ) {
                        found = 1;
                    }
                });
