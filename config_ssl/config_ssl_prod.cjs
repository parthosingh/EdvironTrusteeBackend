...
try {
  ...
  data['files']['/etc/pki/tls/certs/server.crt']['source'] =
    'https://edv-certificates.s3.ap-south-1.amazonaws.com/prod/vanilla_certificate.crt';
  data['files']['/etc/pki/tls/certs/server.key']['source'] =
    'https://edv-certificates.s3.ap-south-1.amazonaws.com/prod/vanilla_private.key';
